...
- [x] 시작일 확정 — Day 1 = 2026-08-12(수), ~~Day 20 = 8/31(월)~~ ~~9/3(목)~~ → **Day 20 = 9/8(화) 런칭·게시**, 판정일 9/22(화), Day 6 = 8/21(금), 버퍼 4일 = 9/2~9/5 (8/20 버퍼 소진 1 — 8/20이 Day 5 잔여·EOD로 소진돼 지렛대 0으로 1일 흡수, 런칭일 불변, PLAN §일정 매핑)
