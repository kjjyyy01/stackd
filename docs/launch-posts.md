...
> ⏰ **런칭·게시일 변경 (2026-09-10, 사용자 결정)**: ~~9/8~~ → **9/10(목)로 통일**. 배포(`be689d1`)는 9/8 선행 완료됐으나 공개 런칭일을 게시일과 같은 **9/10**로 잡는다 — 9/10에 게시하므로 본문 "오늘 런칭했습니다"는 그대로 맞다. 판정일 9/22→**9/24(목)**(런칭 9/10+14). **"8/19 이후 런칭일 불변" 소재는 삭제**(2026-09-10 사용자 판정 — 런칭 9/8→9/10로 무효화): 소재 블록·프로세스 문단·"3주 동안 있었던 일" 목록·재게시 후보에서 제거 완료. *(이전 기록: "9/8 오전"→"9/8 저녁"→"9/10 통일".)*
