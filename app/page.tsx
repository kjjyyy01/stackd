...
// SCR-001 홈 메타 — 제목·설명은 PRD-04 표 그대로. hero-card.png는 OG 전용 잔존
  ...
  return (
    <main className="flex-1">
      ...
      <section aria-label="만드는 과정" className="border-t border-border py-16 sm:py-24">
        <div className="container-page">
          ...
          <ol className="relative mt-12 grid gap-14">
            ...
            <li className="relative grid grid-cols-[2rem_minmax(0,1fr)] gap-4 sm:gap-6">
      ...
      <section id="builder" className="scroll-mt-14 border-t border-border py-16 sm:py-24">
        <div className="container-page">
          <h2 className="text-2xl sm:text-3xl">내 워크플로우 적기</h2>
          <p className="mt-3 max-w-[62ch] text-muted-foreground">
